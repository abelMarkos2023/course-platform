CREATE TYPE "public"."productStatuses" AS ENUM('public', 'private');--> statement-breakpoint
CREATE TYPE "public"."role" AS ENUM('user', 'admin');--> statement-breakpoint
CREATE TYPE "public"."courseSectionStatus" AS ENUM('public', 'private');--> statement-breakpoint
CREATE TYPE "public"."lessonStatuses" AS ENUM('public', 'private', 'preview');--> statement-breakpoint
...
CREATE TABLE "courseSection" (
	...
	"courseId" uuid NOT NULL,
	"name" text NOT NULL,
	"status" "courseSectionStatus" DEFAULT 'private' NOT NULL,
	"createdAt" timestamp with time zone DEFAULT now() NOT NULL,
	"updatedAt" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
CREATE TABLE "lesson" (
	...
	"status" "lessonStatuses" DEFAULT 'private' NOT NULL,
